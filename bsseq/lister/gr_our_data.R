...
## Get positions from the high coverage Cs in our data
...
gr_all_highCov <- rowRanges(BSobj)
rm(BSobj)
save(gr_all_highCov, file = 'gr_all_highCov.Rdata')

## Get positions of CpGs with cov >=3
load('/dcl01/lieber/ajaffe/lab/brain-epigenomics/bumphunting/BSobj_bsseqSmooth_Neuron_minCov_3.Rdata')
gr_cpgs <- rowRanges(BSobj)
save(gr_cpgs, file = 'gr_cps_minCov_3.Rdata')
