...
#$ -N Extract_report_Stroud_Greenberg
#$ -pe local 4
#$ -t 1-4
#$ -tc 10
#$ -m a
...
cd /dcl02/lieber/WGBS/PublicData/Stroud_Greenberg_Cell_2017/BAMS/WGBS/
...
/dcl01/lieber/WGBS/Software/Bismark_v0.19.0/bismark_methylation_extractor \
	...
	--output /dcl02/lieber/WGBS/PublicData/Stroud_Greenberg_Cell_2017/BAMS/WGBS/reports \
