...
/users/ajaffe/software/sratoolkit.2.8.1-3-centos_linux64/bin/fastq-dump -O /dcl02/lieber/WGBS/PublicData/Stroud_Greenberg_Cell_2017/FASTQ/WGBS/ --split-3 --gzip $ID
